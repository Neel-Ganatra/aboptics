        ...
        <div className="min-h-screen font-sans">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
                ...
                <div className="absolute inset-0 z-0 pointer-events-none">
                    ...
                    <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-brand-amber/10 rounded-full blur-[100px]" />
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
                    ...
                    >
                        <span className="text-brand-gold font-bold tracking-widest uppercase text-xs md:text-sm">
                    ...
                    <motion.h1
                        ...
                        className="text-4xl sm:text-6xl md:text-8xl font-extrabold tracking-tight mb-6 md:mb-8 leading-tight"
                    >
                        Store at Your <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold via-brand-yellow to-brand-amber drop-shadow-[0_0_15px_rgba(255,193,7,0.3)]">
                            Doorstep
                        </span>
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-lg md:text-2xl text-gray-300 mb-8 md:mb-12 max-w-2xl mx-auto font-light leading-relaxed px-4"
                    >
                    ...
                    >
                        <Link to="/home-store" className="w-full sm:w-auto px-6 py-4 md:px-8 bg-gradient-to-r from-[#FFC107] to-[#FF9800] text-black font-bold text-base md:text-lg rounded-xl shadow-[0_0_30px_rgba(255,193,7,0.4)] hover:shadow-[0_0_50px_rgba(255,193,7,0.6)] hover:scale-105 transition-all flex items-center justify-center">
                            Book Home Visit <ArrowRight className="ml-2 w-5 h-5" />
                        </Link>
                        <Link to="/shop" className="w-full sm:w-auto px-6 py-4 md:px-8 bg-transparent border border-[#FFC107] text-white font-bold text-base md:text-lg rounded-xl hover:bg-[#FFC107]/10 hover:border-[#FFC107]/80 hover:text-[#FFC107] transition-all flex items-center justify-center">
                            Explore Collection
                        </Link>
                    </motion.div>
                        ...
                        <div key={i} className="flex space-x-12">
                            {['Gucci', 'Prada', 'Versace', 'Tom Ford', 'Burberry', 'Ray-Ban', 'Oakley', 'Carrera'].map((brand) => (
                                <div key={brand} className="px-8 py-4 bg-white/5 rounded-xl border border-white/10 min-w-[150px] flex items-center justify-center">
                                    <span className="text-xl md:text-2xl font-serif font-bold text-gray-400 opacity-70 hover:opacity-100 hover:text-brand-gold transition-all cursor-default">
                                        {brand}
                                    </span>
                                </div>
                            ))}
            ...
            <section id="services" className="py-24 relative z-10">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            <div className="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mb-6 text-brand-gold text-3xl">#</div>
                            <h3 className="text-3xl font-bold mb-4 font-serif">Premium Frames</h3>
                            ...
                            <Link to="/shop" className="text-brand-gold font-bold flex items-center hover:translate-x-2 transition-transform">
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-bold mb-4 font-serif">Sunglasses & Power Specs</h3>
                        ...
                        >
                            <div className="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mb-6 text-brand-gold text-3xl">👓</div>
                            <h3 className="text-3xl font-bold mb-4 font-serif">All Brand Lenses</h3>
                            <p className="text-gray-400 mb-6 leading-relaxed">
            ...
            <section id="why-us" className="py-24 bg-brand-dark/30">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="mb-16">
                        <h4 className="text-brand-gold font-bold tracking-widest uppercase mb-2">OUR UNIQUE SERVICE</h4>
                        <h2 className="text-5xl md:text-6xl font-serif font-bold text-white mb-6">
                            We Bring the <br />
                            <span className="text-brand-gold">Store to You</span>
                        </h2>
